...
test_that("test that define_palette() returns the correct palette", {
  ...
  expect_equal(define_palette("default", type = "Protein"), default_pal)
  expect_equal(define_palette("default", type = "Nucleotide"), default_nuc_pal)
  expect_equal(define_palette("default", type = "Character"), default_char_pal)
